...
Recommend also downloading ImageOptimCL and running it over the directory
afterwards using:
...
help_msg = ("The extension you want the files saved as. "
            "This defaults to whatever format the source file is.")

parser = argparse.ArgumentParser(
    description='Resize images and save in a directory')
...
parser.add_argument('--ext', help=help_msg)
...
args = parser.parse_args()
imgs = [os.path.join(args.dir, f) for f in os.listdir(args.dir)]

if args.height or args.width or args.ext:
    target_dir = os.path.join(args.dir, "thumbs")
    target_size = (args.height or 128, args.width or 128)
    target_ext = args.ext or 'png'
