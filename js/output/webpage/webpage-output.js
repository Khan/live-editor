...
window.WebpageOutput = Backbone.View.extend({
    ...
    getLintMessage: function(plainError) {
        ...
        return ({
            ...
            INVALID_CSS_PROPERTY_NAME: i18n._("The CSS property \"%(cssProperty_property)s\" is unknown. Check your spelling.", error),
            ...
            NONSTANDARD_CSS_PROPERTY_NAME: i18n._("\"%(cssProperty_property)s\" is non-standard, check browser compatibility.", error),
