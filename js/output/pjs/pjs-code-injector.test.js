...
describe("PJSCodeInjector static functions", function() {
    it("stringifyArray should work correctly", function() {
        ``;
...
describe("PJSCodeInjector AST Transforms", function() {
    ...
    it("should handle 'for' loops with variable declarations", function() {
        var transformedCode = transformCode(
    ...
    it("should substitute all 'NewExpression's with 'CallExpression's to '__env__.PJSOutput.applyInstance'", function() {
        ...
        var expectedCode = cleanupCode(
            getCodeFromOptions(function() {
                ...
                __env__.myInstance = __env__.PJSOutput.applyInstance(
                    __env__.Obj,
                    "Obj",
                )(1);
            }),
...
describe("PJSCodeInjector AST Transforms for exporting", function() {
    var transformCode = function(code) {
