import {getMockedTooltip, getTooltip, testMockedTooltipDetection, testReplace} from "./shared.js";
import NumberScrubber from "../../js/ui/tooltips/number-scrubber.js";
...
describe("numberScrubber - detection", function() {
    ...
    before(function () {
        ...
        mockedNumberScrubber = getMockedTooltip(sandbox, NumberScrubber, ["detector", "initialize"])
    });
...
describe("numberScrubber - selection (what it replaces)", function() {
    ...
    beforeEach(function () {
        sandbox = sinon.sandbox.create();
        numberScrubber = getTooltip(NumberScrubber);
    });
