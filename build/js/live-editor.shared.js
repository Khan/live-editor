...
window.AllImages = [{
    ...
    "groupName": "pixar",
    "images": ["army1", "army2", "bedspread", "bing1", "bing2", "bopeep", "buzz", "cars1", "floorplanes", "food1", "ham", "lamp", "luxoball", "rat_1", "rat_2", "rat_3"]
}, {
...
var ScratchpadConfig = Backbone.Model.extend({
    ...
    versions: [{
        ...
        ace_java_editor: function ace_java_editor(editor) {
            var aceEditor = editor.editor;
