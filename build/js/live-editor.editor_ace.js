    ...
    bindRecord: function bindRecord() {
        ...
        doc.on("change", function (eventInfo) {
            ...
            if (eventInfo.action.indexOf("insert") === 0) {
                ...
                self.record.log(eventInfo.lines.action, start.row, start.column, end.row, end.column, insert);
            } else {
                self.record.log(eventInfo.lines.action, start.row, start.column, end.row, end.column);
            }
        }, true);
